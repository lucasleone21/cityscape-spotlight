  ...
  useEffect(() => {
    ...
    if (!markersInitializedRef.current || havePropsChanged()) {
      ...
      markers.forEach((m) => {
        const size = 32;
        const icon = L.divIcon({
          html: `<svg width="32" height="32" viewBox="0 0 24 24" fill="#dc2626" stroke="#000000" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" class="chef-hat-marker">
